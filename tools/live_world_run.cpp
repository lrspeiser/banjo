...
nlohmann::json costOf(const LiveBreakCost &cost) {
    ...
    return {{"material", cost.material},
            ...
            {"available_energy_j", tidy(cost.available_energy_j)},
            {"available_kinetic_j", tidy(cost.available_kinetic_j)},
            {"available_elastic_j", tidy(cost.available_elastic_j)},
            {"spent_it_all", cost.spent_it_all},
