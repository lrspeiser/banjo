 ...
 *
 * 19 made one material state drive everything (docs/thermal-mechanics.md, "One
 ...
 * signature changed. A caller built against 18 must be rebuilt. */
#define BANJO_ABI_VERSION 19
