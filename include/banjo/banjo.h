 ...
 *
 * Kept: banjo_snapshot keeps the stores (what each holds and has given), the
 * motors (each one's command, brake and account, and what it said of its last
 ...
 * they stood, and goes on winding. */
...
typedef struct {
    ...
    /* +1 if the drum turning the positive way about its axle takes rope on,
     * -1 if turning the other way does: as banjo_drum was told. */
    int winds;
} banjo_drum_rope;
