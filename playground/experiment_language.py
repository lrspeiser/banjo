...
KINDS = ["panel_impact", "plate_drop", "rigid_drop", "knife_cut", "custom_objects",
         "thermal_frontier", "material_state_reference", "glass_reference", "unsupported"]
...
LIMITATIONS = [
    ...
    "Tempered-glass calibration, spatial metal dents and complete tomato slicing are not implemented.",
    "J2 plasticity, compact state/history and bounded property variation are reference modules, not live-world capabilities.",
    "Native studio executes a fresh simulation; its playback is separate from the headless report."
]
...
Never claim realistic/calibrated glass shattering, full wood grain, spatial metal dents, full tomato slicing, gameplay repair, live-world persistence, fire spreading through arbitrary geometry, or fluids. These are goals, not implemented capabilities.
