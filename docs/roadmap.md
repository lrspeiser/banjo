...
**Event/material progress at `dc49f1293dd656bac3a33e717e1a9bd29555bf5d`:** analytical contact phase, finite reaction, restitution work, whole-interval rollback and transformed-frame checks pass. Glass/oak/iron now share raw and event reference scenarios; the [36-case matrix](event-material-checkpoint.md) records 21 accepted runs and 15 rejections. Coarse accepted impacts still disagree with timestep, and full-resolution/dissipative events remain unresolved. Fix event limits and establish temporal accuracy before runtime integration. Keep the [mechanics scorecard](mechanics-scorecard.md) current; every material-dependent extension must retain at least glass and oak, with iron retained in the growing set.
