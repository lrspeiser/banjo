...
- **16** added rolling resistance -- every round body rolling on anything is
...
A library at 16 has all of them. Nothing that was in 12 changed, nothing that
was in 14 changed in 15, and no struct or signature that was in 15 changed in
16.
